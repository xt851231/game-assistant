...
const MediaControlHub: React.FC<MediaControlHubProps> = ({ isOpen, config, onConfigChange, onClose }) => {
    ...
    return (
         <div className="absolute top-14 right-20 z-50 w-[300px] rpg-window shadow-2xl animate-in fade-in slide-in-from-top-2 duration-200">
             <div className="bg-blue-900 border-b-2 border-white p-2 flex items-center gap-2">
                 <Settings2 className="text-[#ffd700]" size={16} />
                 <h2 className="font-pixel text-[10px] text-white">Media Hub</h2>
             </div>
             
             <div className="p-4 bg-[#0a0f16] space-y-4">
                 ...
                 <div className="grid grid-cols-3 gap-2">
                     <button
                        ...
                        className={`flex flex-col items-center justify-center p-2 rounded border border-gray-600 transition-colors ${
                            config.audioEnabled ? 'bg-blue-900/50 border-blue-400' : 'bg-[#162032] text-gray-500'
                        }`}
                     >
                         <Mic size={16} />
                     ...
                     <button
                        ...
                        className={`flex flex-col items-center justify-center p-2 rounded border border-gray-600 transition-colors ${
                            config.videoEnabled ? 'bg-blue-900/50 border-blue-400' : 'bg-[#162032] text-gray-500'
                        }`}
                     >
                         <Video size={16} />
                     ...
                     <button
                        ...
                        className={`flex flex-col items-center justify-center p-2 rounded border border-gray-600 transition-colors ${
                            config.screenShareEnabled ? 'bg-blue-900/50 border-blue-400' : 'bg-[#162032] text-gray-500'
                        }`}
                     >
                         <Monitor size={16} />
